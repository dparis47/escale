...
export default async function BilanCpamArsPage({
  searchParams,
}: {
    ...
    <main className="container mx-auto px-4 py-6 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-2xl font-bold">Bilan CPAM / ARS — {annee}</h1>
        </div>
        <div className="flex items-center gap-3">
          <SelecteurAnnee anneeMin={anneeMin} anneeMax={anneeActuelle} anneeSelectionnee={annee} />
          <BoutonExport type="cpam-ars" annee={annee} />
        </div>
      </div>
